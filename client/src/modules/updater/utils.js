...
const MOD_GROUP_FILE_PATTERNS = [
    ...
    { id: 'etf_emf_cit', files: ['client-entity_texture_features', 'client-entity_model_features', 'client-citreforged'] },
    ...
    { id: 'forgematica', files: ['client-forgematica', 'client-Forgematica', 'client-mafglib', 'client-badpackets', 'client-neoforgematicaprinter', 'client-NeoForgematicaPrinter'] },
